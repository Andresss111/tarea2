...
<body>
	...
	<main>
		...
		<section id="contactenos" class="seccion">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="columna columna-41 empujar-58 columna-mobile-100 empujar-movile-0 sinpadding-movile">
									...
									if(isset($nombre)){
										if(isset($mail)){
											if(isset($mensaje)){
												...
												$asunto="Prueba";
												$cuerpo=$nombre."\n".$mail."\n".$mensaje;
												$adicional="from:Andres@gmail.com";
		...
		<div class="container">
			<div class="row">
				...
				<div class="columna columna-25 columna-mobile-100">
					...
					<ul>
						<li>gallegosandres.tareas@gmail.com</li>
						<li>0912345678</li>
						<li>Avenida de las Américas<br>Cuenca-Ecuador</li>
					</ul>
				</div>
				<div class="columna columna-25 columna-mobile-100">
